...
packages <- c("tidyverse","tidytext","dplyr","ggplot2","broom",
              ...
              'ggraph', 'igraph', "xts", "zoo", "purrrlyr", "servr")
...
#barplot(doc_topic_distr[1, ], xlab = "topic", #don't run
...
![Online News](images/newsheader.jpg)
...
1)	Sort through and identify key events in the large corpus of news events by:
    a.	Time period;
    b.	Topic and; 
    c.	Keyword 
2)	Understand in greater detail the context around each theme and news source by
    a.	Sentiment and; 
    b.	Word structure
3)	Be alerted to unusual patterns 
...
lda_model$plot(out.dir = "animations/ldavis", open.browser = FALSE)
```
```{r, eval=FALSE}
lda_model$plot()
```
<head>
  ...
  <title>LDAvis</title>
  <script src="animations/ldavis/d3.v3.js"></script>
  <script src="animations/ldavis/ldavis.js"></script>
  <link rel="stylesheet" type="text/css" href="animations/ldavis/lda.css">
</head>

<body>
  <div id = "lda"></div>
  <script>
    var vis = new LDAvis("#lda", "animations/ldavis/lda.json");
  </script>
</body>
